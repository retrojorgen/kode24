  ...
  render () {
    return (
      <ColorLogoStyle enable-background="new 0 0 594 166" version="1.1" viewBox="0 0 594 166"  xmlns="http://www.w3.org/2000/svg" width="300" height="100">
        <path className={`st0 ${this.state.animate ? 'animate': ''}`} d="m115.4 17.4v97l-93.5-51.2 93.5-45.8z"/>
        ...
        <path className={`st1 ${this.state.animate ? 'animate': ''}`} d="m115.4 94.5"/>
        <path className={`st2 ${this.state.animate ? 'animate': ''}`} d="M182,94.5l-93.5,51.3v-97L182,94.5z"/>
        ...
        <path className={`st3 ${this.state.animate ? 'animate': ''}`} d="m88.4 121.9"/>
        <path className={`st0 ${this.state.animate ? 'animate': ''}`} d="m115.4 114.4l-93.2-51"/>
