...
<linearGradient id="b" x1="115.4" x2="115.4" y1="94.47" y2="94.47" gradientUnits="userSpaceOnUse">
	...
	<stop stop-color="#F20E72" offset=".5325"/>
	<stop stop-color="#3CB6D2" offset="1"/>
	<stop stop-color="#FE330A" offset="1"/>
</linearGradient>
<path class="st1" d="m115.4 94.5"/>
...
const WhiteOutlineShortLogo = () =>
  <WhiteOutlineShortLogoStyle id="logo" enable-background="new 0 0 444 157.5" version="1.1" viewBox="0 0 444 157.5" xmlns="http://www.w3.org/2000/svg" width="160" height="80">
    <polyline class="st0" points="113.6 55.3 113.6 12.4 13.1 61.2 102.3 110.7"/>
    <line class="st0" x1="113.6" x2="113.6" y1="104.3" y2="71.8"/>
    <polyline class="st0" points="99.5 48.5 99.5 35.4 45.5 61.7 99.5 91.7 99.5 65.2"/>
    <polyline class="st0" points="84.8 41.8 176.7 86.5 76.2 142.2 76.2 95.7"/>
    <line class="st0" x1="76.2" x2="76.2" y1="78" y2="46.7"/>
    <polyline class="st0" points="90.2 85.8 90.2 60.7 144.3 87 90.2 116.9 90.2 104.3"/>
    <path class="st0" d="m204.1 34.1h29.7 29l-16.2 32.2 20.5 40.7h-63.1v-72.9z"/>
    <path class="st0" d="m305.2 20.9h11.9l-32.3 100.8h-11.9l32.3-100.8z"/>
    <path class="st0" d="M415.3,33.1v33.5h12.4v19.6h-12.4v19.1h-16.5V86.2h-26.7l0.5-53.3"/>
    <path class="st0" d="m308.6 106h51.1v-20.3h-15.9c2.2-1.1 4.3-2.5 6.3-4.4s3.8-4 5.4-6.3c1.5-2.4 2.8-4.9 3.7-7.5 0.9-2.7 1.4-5.3 1.4-7.9 0-3.7-0.7-7.2-2.1-10.4s-3.3-6.1-5.7-8.5-5.2-4.3-8.5-5.7c-3.2-1.4-8.6-2.2-12.3-2.2"/>
